...
document.getElementById("contactForm").addEventListener("submit", function (event) {
  ...
  if (name && email && message) {
    showToast(); // Call function to show toast notification
    ...
    // Handle validation errors (e.g., display a message or focus on the empty fields)
